...
public class UIButtonColor : UIWidgetContainer
{
	...
	private UIWidget _cacheWidget;
	private UIWidget cacheWidget {
		get { 
			if (!_cacheWidget) {
				_cacheWidget = GetComponent<UIWidget> ();
			}
			return _cacheWidget;
		}
	}
    ...
    public void UpdateColor(bool instant) {
        ...
        if (tweenTarget != null) {
			...
			*/
            switch (mState) {
                case State.Hover: cacheWidget.color = hover; break;
                case State.Pressed: cacheWidget.color = pressed; break;
                case State.Disabled: cacheWidget.color = disabledColor; break;
                default: cacheWidget.color = mDefaultColor; break;
            }
